...
Mailjet.prototype.sendContent = function(from, to, subject, type, content) {
  ...
  //content = (content + "<table style='width:100%;'><tr style='width:100%;'><td style=\"text-align:center; width:100%; font-size:16px; margin-top: 15px; display:block; font-weight:500; font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; text-transform: uppercase;\">Donnez vie à vos événements !<img src=\"http://www.eqwall.com/static/logo.png\" alt=\"eqwall\" height=\"55\" style='display:block;margin:15px auto 0;'/></td></tr></table>").replace(/(?:\r\n|\r|\n)/g, '<br />');
