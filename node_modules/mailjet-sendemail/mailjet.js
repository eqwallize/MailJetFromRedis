...
Mailjet.prototype.sendContent = function(from, to, subject, type, content) {
  ...
  content = (content + '<br /><div style="text-align:center;width:100%;"><span style="font-size:16px;display:block;margin-bottom:15px;font-weight:500;font-family: "Lucida Sans Unicode", "Lucida Grande", sans-serif;">DONNEZ VIE A VOS EVENEMENTS</span><img src="http://www.eqwall.com/static/logo.png" alt="eqwall" height="55"/></div>').replace(/(?:\r\n|\r|\n)/g, '<br />');
